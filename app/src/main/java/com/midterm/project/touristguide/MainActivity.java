...
public class MainActivity extends AppCompatActivity {
    ...
    public List<Landmark> getListLandmark() {
        list = new ArrayList<>();
        list.add(new Landmark(new int[]{R.drawable.picture_1,R.drawable.picture_2},"Indedenpence Palace","This is the place marking the complete victory of anti-American resistance war, libration of the South and national reunification.",5,"https://en.wikipedia.org/wiki/Independence_Palace","02838223652","135 Đ. Nam Kỳ Khởi Nghĩa, Phường Bến Thành, Quận 1, Thành phố Hồ Chí Minh"));
